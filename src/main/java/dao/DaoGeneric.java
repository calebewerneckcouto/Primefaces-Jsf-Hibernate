...
public class DaoGeneric<E> {
	...
	public void deletarPoId(E entidade) throws Exception{
		...
		EntityTransaction transaction = entityManager.getTransaction();// Obejeto de transa̤̣o
		transaction.begin();// Come̤a uma Transa̤̣o no banco de dados
		...
		transaction.commit();// Grava altera̤̣o no banco
	...
	public List<E> listar(Class<E> entidade) {
		...
		List<E> lista = entityManager.
				createQuery("from " + entidade.getName())//Cria a queru de consulta
